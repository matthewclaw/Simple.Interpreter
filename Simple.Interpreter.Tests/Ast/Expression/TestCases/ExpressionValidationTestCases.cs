...
namespace Simple.Interpreter.Tests.Ast.Expression.TestCases
{
    internal class ExpressionValidationTestCases : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            yield return new ExpressionValidationTest("context.MyProperty4", new Dictionary<string, Type> { { "context", typeof(ExpressionTestObject) } }, new List<string> { "Member 'MyProperty4' not found in context." });
